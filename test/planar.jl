...
@testset "planar methods" verbose = true begin
    @testset "planaradd" begin
        ...
        @test force_planar(tensoradd!(C, A, p, :N, true, true)) ≈
    ...
    @testset "planartrace" begin
        ...
        @test force_planar(tensortrace!(C, A, p, q, :N, true, true)) ≈
    ...
    @testset "planarcontract" begin
        ...
        @test force_planar(tensorcontract!(C, A, pA, :N, B, pB, :N, pAB, true, true)) ≈
